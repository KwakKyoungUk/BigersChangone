...
@Controller
public class SUIP1130Controller extends BaseController{

	@Autowired
	private AppMngDataService appMngDataService;

	@RequestMapping(value="/SUIP1130/appMng", method={RequestMethod.GET})
	public String goView() throws Exception{

		return "jsp/funeralsystem/suip0000/suip1000/SUIP1130";
	}

	@RequestMapping(value="/SUIP1130/appMng", params="actionTp=appMngDataSrchList", method={RequestMethod.POST})
	public String appMngList(AppMngDataSrch appMngDataSrchSearch, Model model) throws Exception{
		AppMngDataSrch appMngDataSrch = appMngDataService.appMngDataSrchInsertDetailBiz(appMngDataSrchSearch);
		model.addAttribute("appMngDataSrch", appMngDataSrch);
		return "jsp/funeralsystem/suip0000/suip1000/SUIP1130";
	}

	@RequestMapping(value="/SUIP1130/appMng", params="actionTp=appMngDataSrchInsert", method={RequestMethod.POST})
	@Transactional
	public String appMngInsert(AppMngDataSrch appMngDataSrchSearch, Model model, HttpServletRequest request) throws Exception{
		...
		appMngDataSrch = appMngDataService.appMngDataSrchInsertDetailBiz(appMngDataSrchSearch);
