...
@Controller
public class SUIP1151Controller extends BaseController{

	@Autowired
	private AppMngDataService appMngDataService;

	@RequestMapping(value="/SUIP1151/appMngLay", method={RequestMethod.GET})
	public String goView() throws Exception{

		return "jsp/funeralsystem/suip0000/suip1000/SUIP1151";
	}

	@RequestMapping(value="/SUIP1151/appMngLay", params="actionTp=appMngDataSrchList", method={RequestMethod.POST})
	public String appMngList(AppMngDataSrch appMngDataSrchSearch, Model model) throws Exception{
		AppMngDataSrch appMngDataSrch = appMngDataService.appMngDataSrchLayInsertDetailBizMasan(appMngDataSrchSearch);
		model.addAttribute("appMngDataSrchSearch", appMngDataSrchSearch);
		model.addAttribute("appMngDataSrch", appMngDataSrch);
		return "jsp/funeralsystem/suip0000/suip1000/SUIP1151";
	}

	@RequestMapping(value="/SUIP1151/appMngLay", params="actionTp=appMngDataSrchInsert_one", method={RequestMethod.POST})
	@Transactional
	public String appMngInsert(AppMngDataSrch appMngDataSrchSearch, Model model, HttpServletRequest request) throws Exception{
		...
		appMngDataSrch = appMngDataService.appMngDataSrchLayInsertDetailBizMasan(appMngDataSrchSearch);
