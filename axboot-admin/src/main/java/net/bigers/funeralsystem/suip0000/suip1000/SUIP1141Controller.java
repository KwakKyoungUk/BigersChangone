...
@Controller
public class SUIP1141Controller extends BaseController{

	@Autowired
	private AppMngDataService appMngDataService;

	@RequestMapping(value="/SUIP1141/appMngListHwa", method={RequestMethod.GET})
	public String goView() throws Exception{

		return "jsp/funeralsystem/suip0000/suip1000/SUIP1141";
	}

	@RequestMapping(value="/SUIP1141/appMngListHwa", params="actionTp=appMngDataSrchList", method={RequestMethod.POST})
	public String appMngList(AppMngDataSrch appMngDataSrchSearch, Model model) throws Exception{
		AppMngDataSrch appMngDataSrch = appMngDataService.appMngDataSrchInsertDetailBizMasan(appMngDataSrchSearch);
		model.addAttribute("appMngDataSrchSearch", appMngDataSrchSearch);
		model.addAttribute("appMngDataSrch", appMngDataSrch);
		return "jsp/funeralsystem/suip0000/suip1000/SUIP1141";
	}

	@RequestMapping(value="/SUIP1141/appMngListHwa", params="actionTp=appMngDataSrchInsert_one", method={RequestMethod.POST})
	@Transactional
	public String appMngInsert(AppMngDataSrch appMngDataSrchSearch, Model model, HttpServletRequest request) throws Exception{
		...
		appMngDataSrch = appMngDataService.appMngDataSrchInsertDetailBizMasan(appMngDataSrchSearch);
