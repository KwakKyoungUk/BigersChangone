...
@Controller
public class SUIP1150Controller extends BaseController{

	@Autowired
	private AppMngDataService appMngDataService;

	@RequestMapping(value="/SUIP1150/appMngLay", method={RequestMethod.GET})
	public String goView() throws Exception{

		return "jsp/funeralsystem/suip0000/suip1000/SUIP1150";
	}

	@RequestMapping(value="/SUIP1150/appMngLay", params="actionTp=appMngDataSrchLayList", method={RequestMethod.POST})
	public String appMngList(AppMngDataSrch appMngDataSrchSearch, Model model) throws Exception{
		AppMngDataSrch appMngDataSrch = appMngDataService.appMngDataSrchLayInsertDetailBiz(appMngDataSrchSearch);
		model.addAttribute("appMngDataSrchSearch", appMngDataSrchSearch);
		model.addAttribute("appMngDataSrch", appMngDataSrch);
		return "jsp/funeralsystem/suip0000/suip1000/SUIP1150";
	}

	@RequestMapping(value="/SUIP1150/appMngLay", params="actionTp=appMngDataSrchLayInsert", method={RequestMethod.POST})
	@Transactional
	public String appMngInsert(AppMngDataSrch appMngDataSrchSearch, Model model, HttpServletRequest request) throws Exception{
		...
		appMngDataSrch = appMngDataService.appMngDataSrchLayInsertDetailBiz(appMngDataSrchSearch);
