...
@Controller
public class DISP0011Controller extends BaseController{
	...
	private Pageable pageRequest = new PageRequest(0, 3);

	@Scheduled(fixedDelay=10000)
	@Transactional
	public void board(){

		if(!sessionManager.containsByUri("/wst/DISP0011")){
			return;
		}

		Page<Funeral> displayInfo = this.funeralService.getDisplayInfo(pageRequest);

		sessionManager.sendTextMessageByUri("/wst/DISP0011", "board", new Object() {
			@Getter
