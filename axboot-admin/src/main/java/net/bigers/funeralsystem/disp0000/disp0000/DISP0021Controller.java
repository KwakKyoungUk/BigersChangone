 ...
 */
@Controller
public class DISP0021Controller extends BaseController{
	...
	private Pageable pageRequest = new PageRequest(0, 7, new Sort(Sort.Direction.ASC, "ibkwanDate"));
	...
	public void board(){
		...
		if(!sessionManager.containsByUri("/wst/DISP0021")){
			return;
		}
		...
		sessionManager.sendTextMessageByUri("/wst/DISP0021", "board", new Object() {
			@Getter
