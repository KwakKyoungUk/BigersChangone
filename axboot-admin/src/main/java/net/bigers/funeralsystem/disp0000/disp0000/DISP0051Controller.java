...
@Controller
public class DISP0051Controller extends BaseController{
	...
	public void board(){
		...
		if(!sessionManager.containsByUri("/wst/DISP0051")){
			return;
		}

		Funeral funeral = this.funeralService.getCurrentBalinFuneral();

		sessionManager.sendTextMessageByUri("/wst/DISP0051", "board", funeral);
