...
@Controller
public class DISP0010Controller extends BaseController{
	...
	public void board(){
		...
		if(!sessionManager.containsByUri("/wst/DISP0010")){
			return;
		}

		Page<Funeral> displayInfo = this.funeralService.getDisplayInfo(pageRequest);

		sessionManager.sendTextMessageByUri("/wst/DISP0010", "board", new Object() {
			@Getter
