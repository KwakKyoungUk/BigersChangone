...
@Controller
public class FUNE5090Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE5090/machul-type", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE5090/jungsan-type", method={RequestMethod.POST}, produces=APPLICATION_JSON)
