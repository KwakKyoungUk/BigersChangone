...
@Controller
public class FUNE2010Controller extends BaseController{

	@Inject
	private UserMngPartService userMngPartService;
	
	@RequestMapping(value="/FUNE2010/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2010/basiccode", method={RequestMethod.POST}, produces=APPLICATION_JSON)
