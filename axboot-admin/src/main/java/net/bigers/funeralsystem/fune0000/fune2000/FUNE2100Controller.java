...
@Controller
public class FUNE2100Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE2100/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2100/itemgroup", method={RequestMethod.GET}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2100/item" , method= RequestMethod.GET, produces=APPLICATION_JSON )
	...
	@RequestMapping(value="/FUNE2100/code" , method= RequestMethod.POST, produces=APPLICATION_JSON )
