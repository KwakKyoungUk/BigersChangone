...
@Controller
public class FUNE3030Controller extends BaseController{
	
	@Inject
	private UserMngPartService userMngPartService;
	
	@RequestMapping(value="/FUNE3030/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE3030/customer", method={RequestMethod.GET}, produces=APPLICATION_JSON)
