...
@Controller
public class FUNE2150Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE2150/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2150/basiccode", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2150/basiccode2", method={RequestMethod.POST}, produces=APPLICATION_JSON)
