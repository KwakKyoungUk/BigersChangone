...
@Controller
public class FUNE8170Controller extends BaseController{

	@Inject
	private BasicCodeService basicCodeService;
	
	@RequestMapping(value="/FUNE8170/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	public CommonListResponseParams.ListResponse getPartCode(){
		List<BasicCode> list = basicCodeService.findByBasicCd("504");
