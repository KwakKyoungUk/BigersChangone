...
@Controller
public class FUNE4040Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE4040/part", method={RequestMethod.POST}, produces=APPLICATION_JSON) // POST 방식을 사용하였는데, AXSearch 컴포넌트에서 AJAX 요청시 GET 방식으로 받아오지 않기에 POST방식으로 사용하였다.
	...
	@RequestMapping(value="/FUNE4040/recipe/itemGroup" , method= RequestMethod.GET, produces=APPLICATION_JSON )
