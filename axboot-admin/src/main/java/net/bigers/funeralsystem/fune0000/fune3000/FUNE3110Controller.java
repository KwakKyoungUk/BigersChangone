...
@Controller
public class FUNE3110Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE3110/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE3110/itemgroup", method={RequestMethod.GET}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE3110/item" , method= RequestMethod.GET, produces=APPLICATION_JSON )
	public List<Object[]> findItem(@RequestParam Map<String, String> requestBody) throws Exception{
		return this.itemGroupService.findItemHistory(requestBody);
	}
	
	@RequestMapping(value="/FUNE3110/code" , method= RequestMethod.POST, produces=APPLICATION_JSON )
