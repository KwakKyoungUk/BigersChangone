...
@Controller
public class FUNE2160Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE2160/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2160/basiccode", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	public CommonListResponseParams.ListResponse getBasicCode(){
		List<BasicCode> list = BasicCodeService.findByBasicCd("314");
		return CommonListResponseParams.ListResponse.of(list);
	}
	
	@RequestMapping(value="/FUNE2160/basiccode2", method={RequestMethod.POST}, produces=APPLICATION_JSON)
