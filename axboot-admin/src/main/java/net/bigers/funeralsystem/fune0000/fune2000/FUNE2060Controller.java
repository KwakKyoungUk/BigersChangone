...
@Controller
public class FUNE2060Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE2060/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2060/basiccode", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	public CommonListResponseParams.ListResponse getBasicCode(){
		List<BasicCode> list = BasicCodeService.findByBasicCd("111");
		return CommonListResponseParams.ListResponse.of(list);
	}
	
	@RequestMapping(value="/FUNE2060/basiccode2", method={RequestMethod.POST}, produces=APPLICATION_JSON)
