...
@Controller
public class FUNE2030Controller extends BaseController{

	@Inject
	private UserMngPartService userMngPartService;
	
	@RequestMapping(value="/FUNE2030/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2030/basiccode", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2030/basiccode2", method={RequestMethod.POST}, produces=APPLICATION_JSON)
