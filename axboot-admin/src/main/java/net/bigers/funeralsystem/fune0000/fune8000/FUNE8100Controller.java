...
@Controller
public class FUNE8100Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE8100/search-kind-options", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE8100/dead", method={RequestMethod.GET}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE8100/assignedDead", method={RequestMethod.GET}, produces=APPLICATION_JSON)
	public CommonListResponseParams.ListResponse getAssignedDead(){
		List<FuneralVTO> list = funeralService.getAssignedDead();
		return CommonListResponseParams.ListResponse.of(list);
	}

	@RequestMapping(value="/FUNE8100/deadRelation", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	public CommonListResponseParams.ListResponse getDeadRelation(){
		List<BasicCode> list = basicCodeService.findByBasicCd("TCM08");
		return CommonListResponseParams.ListResponse.of(list);
	}
}
