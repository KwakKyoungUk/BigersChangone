...
@Controller
public class FUNE3040Controller extends BaseController{

	@Inject
	private UserMngPartService userMngPartService;
	
	@RequestMapping(value="/FUNE3040/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE3040/customer", method={RequestMethod.GET}, produces=APPLICATION_JSON)
