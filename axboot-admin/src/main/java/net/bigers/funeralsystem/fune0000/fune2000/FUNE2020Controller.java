...
@Controller
public class FUNE2020Controller extends BaseController{

	@Inject
	private UserMngPartService userMngPartService;
	
	@RequestMapping(value="/FUNE2020/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2020/basiccode", method={RequestMethod.POST}, produces=APPLICATION_JSON)
