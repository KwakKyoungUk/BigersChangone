...
@Controller
public class FUNE2120Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE2120/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2120/basiccode", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2120/basiccode2", method={RequestMethod.POST}, produces=APPLICATION_JSON)
