...
@Controller
public class FUNE9020Controller extends BaseController{

	@Inject
	private FuneralService funeralService;

	@RequestMapping(value="/FUNE9020/transfer", method={RequestMethod.GET}, produces=APPLICATION_JSON)
	public CommonListResponseParams.ListResponse getSangjo(String from, String to){

		return CommonListResponseParams.ListResponse.of(this.funeralService.getTransferStat(from, to));
	}
