...
@Controller
public class FUNE6010Controller extends BaseController{
	
	@Inject
	private BasicCodeService BasicCodeService;
	
	@RequestMapping(value="/FUNE6010/basiccode", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE6010/basiccode2", method={RequestMethod.POST}, produces=APPLICATION_JSON)
