...
@Controller
public class FUNE3080Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE3080/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE3080/cust", method={RequestMethod.GET}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE3080/item" , method= RequestMethod.GET, produces=APPLICATION_JSON )
	public List<Object[]> findItem(@RequestParam Map<String, String> requestBody) throws Exception{
		return this.itemService.findItemHistory(requestBody);
	}
