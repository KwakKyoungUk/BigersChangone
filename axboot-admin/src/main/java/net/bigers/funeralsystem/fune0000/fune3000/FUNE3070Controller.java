...
@Controller
public class FUNE3070Controller extends BaseController{
	
	@Inject
	private UserMngPartService userMngPartService;
	
	@RequestMapping(value="/FUNE3070/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE3070/customer", method={RequestMethod.GET}, produces=APPLICATION_JSON)
