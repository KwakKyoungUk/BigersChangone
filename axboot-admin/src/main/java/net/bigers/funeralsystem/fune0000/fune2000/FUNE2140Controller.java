...
@Controller
public class FUNE2140Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE2140/part", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2140/basiccode", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE2140/basiccode2", method={RequestMethod.POST}, produces=APPLICATION_JSON)
