...
@Controller
public class FUNE8010Controller extends BaseController{
	...
	@RequestMapping(value="/FUNE8010/search-kind-options", method={RequestMethod.POST}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE8010/dead", method={RequestMethod.GET}, produces=APPLICATION_JSON)
	...
	@RequestMapping(value="/FUNE8010/assignedDead", method={RequestMethod.GET}, produces=APPLICATION_JSON)
