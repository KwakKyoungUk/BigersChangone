        ...
        <ax:row>
            <ax:col size="12">
                ...
                <div class="ax-button-group">
                    <div class="left">
                        <h2><i class="axi axi-list-alt"></i> 예약문자내역조회</h2>
                    </div>
                    <div class="right">
                    </div>
                ...
                grid: {
                    ...
                    bind: function(){
                        ...
                        target.setConfig({
                            ...
                            colGroup : [
								...
								{key:"trNum", label:"", width:"35", align:"center", display : false},
                                ...
                                {key:"trRsltstat", label:"전송결과", width:"100", align:"center",
                                	formatter: function(){
                                ...
                                {key:"trEtc1", label:" 내용구분", width:"100", align:"center"
                           			, formatter: function(){
                                ...
                                {key:"trMsg", label:"내용", width:"300", align:"center",
                           			editor:{
                                        type:"text",
                                        maxLength: 500,
                                    }
                    ...
                    del:function(){
                        ...
                        $.each(checkedList, function(){
                            if(this.item._CUD != "C"){
                                dto_list.push("trNum=" + this.item.trNum); // ajax delete 요청 목록 수집
                            }
                        });
                        ...
                        if(dto_list.length == 0) {
                            ...
                            app.ajax({
                                type: "DELETE",
                                url: "/SMSM1020/deleteScTran?" + dto_list.join("&"),
                                data: ""
                            },
                            function(res) {
                                if (res.error) {
