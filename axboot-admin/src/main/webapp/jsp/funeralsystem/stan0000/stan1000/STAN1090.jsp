        ...
        <ax:row>
            <ax:col size="12">
                ...
                <div class="ax-button-group">
                    <div class="left">
                        <h2><i class="axi axi-list-alt"></i> 근무자 목록</h2>
                    </div>
                    <div class="right">
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
                                    {label:"근무자명", labelWidth:"", type:"inputText", width:"150", key:"empName", addClass:"", valueBoxStyle:"", value:"",
                ...
                grid: {
                    ...
                    bind: function(){
                        ...
                        target.setConfig({
                            ...
                            colGroup : [
                                ...
                                {key:"empCode", label:"코드", width:"80", align:"center", editor:{
                                    	type:"text"
                                    	, maxLength: 10
                                    	, disabled: function(){
		                                ...
		                                , afterUpdate: function(){
		                                    if(this.item.empCode == "" && this.item.__edting__) toast.push("코드값이 중복됩니다. 입력이 취소 되었습니다.");
		                                    delete target.list[this.index].__edting__;
		                                }
                                	}
                                },
                                {key:"empName", label:"근무자명", width:"100", align:"center",
                                    editor:{
                                        type:"text"
                                        , maxLength: 100
                                    }
                                },
                                {key:"empGubun", label:"직원구분", width:"150"
                                ...
                                {key:"orderseq", label:"정렬순서", width:"80",align:"right",
                                    editor:{  type: "number" }
                                },
                    ...
                    del:function(){
                        ...
                        $.each(checkedList, function(){
                            if(this.item._CUD != "C"){
                                dto_list.push("empCode=" + this.item.empCode); // ajax delete 요청 목록 수집
                            }
                        });
                        ...
                        if(dto_list.length == 0) {
                            ...
                            app.ajax({
                                type: "DELETE",
                                url: "/STAN1090/deleteEmployee?" + dto_list.join("&"),
                                data: ""
                            },
                            function(res) {
                                if (res.error) {
                    ...
                    setPage: function(pageNo, searchParams){
                        ...
                        this.pageNo = pageNo;
                         ...
                         app.ajax({
                             type: "GET",
                             url: "/STAN1090/findEmployee",
                             data:"pageNumber=" + (pageNo-1) + "&pageSize=30&" + (searchParams||fnObj.search.target.getParam())
                         }, function(res){
                             if(res.error){
                                alert(res.error.message);
                             }
