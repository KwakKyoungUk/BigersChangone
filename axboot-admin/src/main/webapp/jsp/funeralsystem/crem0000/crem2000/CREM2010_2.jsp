...
<ax:layout name="modal.jsp">
	<ax:set name="title" value="배우자 봉안자료조회" />
	...
	<ax:div name="contents">
		<ax:row>
			...
			<div class="ax-button-group">
                    <div class="left">
                        <h2><i class="axi axi-table"></i> 배우자 봉안자료조회</h2>
                    </div>
                    <div class="right">
		...
		<script type="text/javascript">
			...
			var fnObj = {
                    ...
                    bind: function(){
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                  ...
                                  {display:true, addClass:"", style:"", list:[
										{label:"봉안일자", labelWidth:"", type:"button", width:"30", key:"leftDate", addClass:"", valueBoxStyle:"", value:"<",
											onclick: function(){
	       											var date = Common.search.getValue(fnObj.search.target, "ensDate").date();
	       											date.setDate(date.getDate()-1);
	        											Common.search.setValue(fnObj.search.target, "ensDate", date.print());
	       											$("#btn-search").click();
	       										}
	       									},
	                                      		{label:"", labelWidth:"", type:"inputText", width:"100", key:"ensDate", addClass:"", valueBoxStyle:"", value:new Date().print(),
	                                           	AXBind:{
	                   								type:"date", config:{
				...
				grid: {
                    ...
                    bind: function(){
                        ...
                        target.setConfig({
                            ...
                            colGroup : [
                                ...
                                {key:"ensDate", label:"봉안일자", width:"100", align:"center"},
                                {key:"ensTypeNm", label:"구분", width:"100", align:"center"},
                                {key:"deadName", label:"고인명", width:"100", align:"center"},
                                {key:"applName", label:"신청자명", width:"100", align:"center"},
                                {key:"mobile", label:"휴대폰", width:"130", align:"center"},
                    ...
                    setPage: function(pageNo, ensDate){
                        var _target = this.target;
                        this.pageNo = pageNo;

                        app.ajax({
                            type: "GET",
                            url: "/CREM2010_2/enshrine/couple",
                            data: "dummy="+ axf.timekey() +"&pageNumber=" + (pageNo-1) + "&pageSize=5&" + (ensDate||fnObj.search.target.getParam())+"&sort=ensDate"
                        }, function(res){
                            if(res.error){
