...
<ax:layout name="modal.jsp">
	<ax:set name="title" value="반환자료 검색" />
		...
		<ax:row>
			<ax:col size="12" wrap="true">
                ...
                <div class="ax-button-group">
                    <div class="left">
                        <h2><i class="axi axi-table"></i> 반환자료 검색</h2>
                    </div>
                    <div class="right">
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                  {display:true, addClass:"", style:"", list:[
                                      ...
                                      {label:"반환일자", labelWidth:"", type:"inputText", width:"90", key:"from", addClass:"secondItem", valueBoxStyle:"", value:new Date().print()},
