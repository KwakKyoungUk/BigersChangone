...
//                     this.search.submit();
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	...
                    	if(fnObj.checked) {Common.report.embedded("/reports/changwon/ensh/ENSH2023", "pdf", params.join("&"), "if-pdf");}
                    	else Common.report.embedded("/reports/changwon/ensh/ENSH2021", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	if(fnObj.checked) {Common.report.go("/reports/changwon/ensh/ENSH2023", "excel", params.join("&"));}
                    	else Common.report.go("/reports/changwon/ensh/ENSH2021", "excel", params.join("&"));
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
               						...
               						{label:"기준일자", labelWidth:"", type:"inputText", width:"90", key:"baseDate", addClass:"", valueBoxStyle:"", value:new Date().print(),
               							AXBind:{
               								type:"date", config:{
               						...
               						{label:"", labelWidth:"", type:"checkBox", width:"", key:"check", addClass:"", valueBoxStyle:"", value:"",
            							options:[{optionValue:"1", optionText:"봉안담 출력시 체크", title:"체크박스"}],
