...
//                     this.search.submit();
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	...
                    	Common.report.embedded("/reports/changwon/ensh/ENSH2024", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	Common.report.go("/reports/changwon/ensh/ENSH2024", "excel", params.join("&"));
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
               						...
               						{label:"기준일자", labelWidth:"", type:"inputText", width:"90", key:"baseDate", addClass:"", valueBoxStyle:"", value:new Date().print("yyyy"),
               							AXBind:{
               								type:"date", config:{
