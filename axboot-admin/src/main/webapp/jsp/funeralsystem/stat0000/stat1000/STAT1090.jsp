...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/stat/STAT1091", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/stat/STAT1091", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
               						{label:"만료예정일", labelWidth:"", type:"inputText", width:"70", key:"from", addClass:"secondItem", valueBoxStyle:"", value:new Date().print(),
               							onChange: function(){}
               						},
               						...
               						{label:"자료구분", labelWidth:"", type:"selectBox", width:"150", key:"DC_GUBUN", addClass:"", valueBoxStyle:"", value:"", 
										options:[
											{optionValue:"0", optionText:"무연고포함"},
											{optionValue:"1", optionText:"무연고제외"},
											{OPTIONvALUE:"2", optionText:"미조치자"}
										],
               							onChange: function(){}
               						}
                                ]}
/*                                 {display:true, addClass:"", style:"", list:[
               						{label:"변경전주소", labelWidth:"", type:"inputText", width:"300", key:"beforeAddr", addClass:"", valueBoxStyle:"", value:"",
               							onChange: function(){}
               						},
               						{label:"변경후주소", labelWidth:"", type:"inputText", width:"300", key:"afterAddr", addClass:"", valueBoxStyle:"", value:"",
               							onChange: function(){}
               						}
                                ]} */
                            ]
