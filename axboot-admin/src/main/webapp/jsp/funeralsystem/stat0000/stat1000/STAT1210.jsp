...
//                     this.search.submit();
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	...
                    	gubun = Common.search.getValue(fnObj.search.target, "gubun");
                    	params.push("from="+from);
                    	params.push("to="+to);
                    	params.push("gubun="+gubun);
                        Common.report.embedded("/reports/changwon/stat/STAT1211", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	params.push("to="+to);
                    	params.push("gubun="+gubun);
                        Common.report.go("/reports/changwon/stat/STAT1211", "excel", params.join("&"));
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
									...
									{label:"구분", labelWidth:"100", type:"selectBox", width:"", key:"gubun", addClass:"", valueBoxStyle:"", value:"",
										options:[{optionValue:"0", optionText:"승인현항"}, {optionValue:"1", optionText:"수입현황"}],
										AXBind:{
											type:"select", config:{
												onChange:function(){
