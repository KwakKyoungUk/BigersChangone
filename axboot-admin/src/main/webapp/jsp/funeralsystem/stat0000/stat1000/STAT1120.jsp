                    ...
                    bind: function(){
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
								...
								{label:"연장일자", labelWidth:"", type:"inputText", width:"70", key:"from", addClass:"secondItem", valueBoxStyle:"", value:new Date().print(),
										onChange: function(){}
									},
...
/* 									{label:"구분", labelWidth:"100", type:"selectBox", width:"", key:"objt", addClass:"", valueBoxStyle:"", value:"",
										options:[{optionValue:"0", optionText:"전체"}, {optionValue:"1", optionText:"시신"}, {optionValue:"2", optionText:"개장유골"}, {optionValue:"3", optionText:"사산아"}],
										AXBind:{
											type:"select", config:{
												onChange:function(){
