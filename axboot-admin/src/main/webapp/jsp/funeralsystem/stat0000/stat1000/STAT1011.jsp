...
//                     this.search.submit();
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	var params = [];
                    	var workDate = null;
                    	workDate = Common.search.getValue(fnObj.search.target, "workDate");
                    	params.push("workDate="+workDate);
                        Common.report.embedded("/reports/changwon/stat/STAT1011", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	workDate = Common.search.getValue(fnObj.search.target, "workDate");
                    	params.push("workDate="+workDate);
                        Common.report.go("/reports/changwon/stat/STAT1011", "excel", params.join("&"));
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
                                	...
                                	{label:"일자", labelWidth:"", type:"button", width:"30", key:"leftDate", addClass:"", valueBoxStyle:"", value:"<",
										onclick: function(){
    										var date = Common.search.getValue(fnObj.search.target, "from").date();
    										date.setDate(date.getDate()-1);
     										Common.search.setValue(fnObj.search.target, "from", date.print());
    										$("#ax-page-btn-search").click();
    									}
    								},
                                   	{label:"", labelWidth:"", type:"inputText", width:"150", key:"from", addClass:"", valueBoxStyle:"", value:new Date().print(),
                                       	AXBind:{
                   							type:"date", config:{
