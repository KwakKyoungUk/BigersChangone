                    ...
                    bind: function(){
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
								...
								{label:"입금연월일", labelWidth:"", type:"inputText", width:"70", key:"from", addClass:"secondItem", valueBoxStyle:"", value:new Date().print(),
										onChange: function(){}
									},
									...
									{label:"구분", labelWidth:"100", type:"selectBox", width:"", key:"objt", addClass:"", valueBoxStyle:"", value:"",
										options:[{optionValue:"0", optionText:"전체"}, {optionValue:"1", optionText:"개인단"}, {optionValue:"2", optionText:"부부단"}],
										AXBind:{
											type:"select", config:{
												onChange:function(){
