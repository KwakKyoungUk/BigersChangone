...
//                     this.search.submit();
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                        ...
                        Common.report.embedded("/reports/changwon/stat/STAT3141", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	params.push("to="+to);
                    	params.push("printName=${LOGIN_USER_ID}");
                        Common.report.go("/reports/changwon/stat/STAT3141", "excel", params.join("&"));
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
               						{label:"세외수납처리일자", labelWidth:"", type:"inputText", width:"70", key:"from", addClass:"secondItem", valueBoxStyle:"", value:new Date().print(),
               							onChange: function(){}
               						},
