            ...
            var fnObj = {
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                		...
                		Common.report.embedded("/reports/changwon/stat/STAT2051", "pdf", params.join("&"), "if-pdfA");
                		Common.report.embedded("/reports/changwon/stat/STAT2052", "pdf", params.join("&"), "if-pdfB");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	var to = null;
                   		...
                   		if(fnObj.CODES.tab == "A"){
                   			Common.report.embedded("/reports/changwon/stat/STAT2051", "excel", params.join("&"), "if-pdfA");
                    	}else if(fnObj.CODES.tab == "B"){
                    		Common.report.embedded("/reports/changwon/stat/STAT2052", "excel", params.join("&"), "if-pdfB");
                    	}
                    });
                },
				...
				tab: {
					...
					, bind: function(){
						this.target.bindTab({
							...
							options:[
								{optionValue:"A", optionText:"이용현황", closable:false},
			  					{optionValue:"B", optionText:"수입현황", closable:false},
			  					],
