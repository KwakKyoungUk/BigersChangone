...
//                     this.search.submit();
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	...
                    	//Common.report.embedded("/reports/changwon/stat/STAT2031", "pdf", params.join("&"), "if-pdf");
                    	Common.report.embedded("/reports/changwon/stat/STAT2032", "pdf", params.join("&"), "if-pdf"); //군복무순직자 추가 버전 20190719 kim
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	//Common.report.go("/reports/changwon/stat/STAT2031", "excel", params.join("&"));
                    	Common.report.go("/reports/changwon/stat/STAT2032", "excel", params.join("&")); //군복무순직자 추가 버전 20190719 kim
