				...
				tab: {
					...
					, bind: function(){
						this.target.bindTab({
							...
							options:[
								{optionValue:"A", optionText:"오산시", closable:false},
			  					{optionValue:"B", optionText:"화성시", closable:false},
			  					{optionValue:"C", optionText:"용인시"},
			  					{optionValue:"D", optionText:"관외 50%25 감면 화장현황"}
			  					],
