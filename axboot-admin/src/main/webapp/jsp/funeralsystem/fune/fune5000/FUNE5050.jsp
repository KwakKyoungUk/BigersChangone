                    ...
                    <ax:custom customid="tr">
                        <ax:custom customid="td" style="width:500px;">
                        	<div class="ax-button-group">
				                    <div class="left">
				                    	<label><input id="info-funeral-gelGb" name="gelGb" type="checkbox" value="1"> 결재</label>
				                    </div>
				                    <div class="right">
				                    </div>
                                    	...
                                    	{label:"조회구분", labelWidth:"", type:"selectBox", width:"150", key:"searchKind", addClass:"", valueBoxStyle:"", value:"close", options:[],
	                                    	AXBind: {
	                                            type: "select", config: {
	                                              ...
	                                              ajaxUrl: "/FUNE5050/search-kind-options",
	                                              ajaxPars: null,
	                                              setValue: "",
	                                              alwaysOnChange: true,
	                                              onChange: function() {
// 	                                            	  _this.submit();
                ...
                grid: {
                    ...
                    setPage: function(pageNo, searchParams){
                        ...
                        var _target = this.target;
                        this.pageNo = pageNo;
                        var url = "/FUNE5050/dead";
                        if(searchKind == '1'){
                        	url = "/FUNE5050/assignedDead";
                        }
                ...
                report: function(params){
                	if($("#info-funeral-gelGb").is(":checked")==true){
	                	var path = "/reports/changwon/fune/FUNE5052";
	                	var output = "pdf";
	                	var frameId = "reportDisplay";
	                	Common.report.embedded(path, output, params, frameId);
	                	toast.push("로딩중입니다.");
                	}else{
                		var path = "/reports/changwon/fune/FUNE5051";
	                	var output = "pdf";
	                	var frameId = "reportDisplay";
	                	Common.report.embedded(path, output, params, frameId);
	                	toast.push("로딩중입니다.");
