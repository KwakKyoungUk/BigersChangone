        ...
        <script type="text/javascript">
            ...
            var fnObj = {
										...
										{label:"조회일자구분", labelWidth:"", type:"selectBox", width:"150", key:"DATE_TYPE", addClass:"", valueBoxStyle:"", value:"close",
											...
											AXBind: {
												...
												config: {
													alwaysOnChange: true,
													onchange: function() {
														$("#"+fnObj.search.target.getItemId("ST_DT")).parent().siblings(".th").text(this.optionText);
													}
												}
											}
										},

										{label:"정산일자", labelWidth:"", type:"inputText", width:"", key:"ST_DT", addClass:"secondItem", valueBoxStyle:"", value:new Date().print(),
											onChange: function(){}
										},
										{label:"", labelWidth:"", type:"inputText", width:"", key:"ED_DT", addClass:"secondItem", valueBoxStyle:"padding-left:0px;", value:new Date().print(),
											AXBind:{
												type:"twinDate", config:{
													align:"right", valign:"top", startTargetID:"ST_DT",
													onChange:function(){
                ...
                report: function(params){
                	var path = "/reports/changwon/fune/FUNE5101";
                	var output = "pdf";
                	var frameId = "if-pdf";
                	trace(params);
