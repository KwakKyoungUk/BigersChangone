    ...
    <ax:div name="contents">
        <ax:row>
            <ax:col>
				...
				<b:button  text="제품생산내역" id="btn-production-list"></b:button>
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	...
                    	etDateTo	= Common.search.getValue(fnObj.search.target, "etDateTo");     
                       	...
                       	if(partCode === "20-001" && groupCode === "99"){
                       		groupCode = "90";
                       	}                       	
                   		...
                   		console.log(params)
                   		Common.report.embedded("/reports/changwon/fune/FUNE4041", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){                    	
                    	...
                    	etDateTo	= Common.search.getValue(fnObj.search.target, "etDateTo");
                   		...
                   		params.push("groupCode="+groupCode);
                   		console.log(params)
                		Common.report.go("/reports/changwon/fune/FUNE4041", "excel", params.join("&"));
                    });
                    //제품생산내역으로 이동
                    $("#btn-production-list").bind("click", function(){                    	
                    	...
                    	var str_url = "/jsp/funeralsystem/fune/fune4000/FUNE4050.jsp?partCode="+partCode
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                ...
                                {display:true, addClass:"", style:"", list:[
										   ...
										   type: "select", config: {
									          ...
									          onChange: function() {
									        	  ...
									        	  $("#" + _target.getItemId("groupCode")).bindSelect({
									        		...
									        		,  	method:"GET"
									        		,	ajaxUrl:"/FUNE4040/recipe/itemGroup"
									...
									{label: "", labelWidth: "100", type: "selectBox", width: "100", key:"groupCode" , addClass:"" , valueBoxStyle:"" , value:"" ,options:[]}
                                ]}
                            ]
                        });
                    },
