            ...
            var fnObj = {
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-excel").bind("click", function(){
	                   	 var params = "customerNo=" + fnObj.grid.target.getSelectedItem().item.customerNo;
	                     fnObj.excel(params);
                    });
                },
                                    	...
                                    	{label:"조회구분", labelWidth:"", type:"selectBox", width:"150", key:"searchKind", addClass:"", valueBoxStyle:"", value:"close", options:[],
	                                    	AXBind: {
	                                            type: "select", config: {
	                                              ...
	                                              ajaxUrl: "/FUNE8180/search-kind-options",
	                                              ajaxPars: null,
	                                              setValue: "",
	                                              alwaysOnChange: true,
	                                              onChange: function() {
// 	                                            	  _this.submit();
                ...
                grid: {
                        ...
                        target.setConfig({
                            ...
                            body : {
                                onclick: function(){
                                    ...
                                    var params = "customerNo=" + this.item.customerNo;
                                    fnObj.report(params);
                                }
                            }
                            /* page: {
                    ...
                    setPage: function(pageNo, searchParams){
                        ...
                        var _target = this.target;
                        this.pageNo = pageNo;
                        var url = "/FUNE8180/dead";
                        if(searchKind == '1'){
                        	url = "/FUNE8180/assignedDead";
                        }
                ...
                report: function(params){
                	var path = "/reports/changwon/fune/FUNE8181";
                	var output = "pdf";
