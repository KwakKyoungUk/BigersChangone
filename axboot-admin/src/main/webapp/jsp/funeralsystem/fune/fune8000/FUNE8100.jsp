                ...
                <ax:custom customid="table">
                    <ax:custom customid="tr">
                        ...
                        <ax:custom customid="td">
                                <table cellpadding="0" cellspacing="0" class="AXGridTable" style="height: 30px;">
						    		<tr>
						    			<th style='width:10%;font-size: 13px;align:left;'>유족 성명
										</th>
						    			<th style="width:20%;text-align:left;">
						    				<input type="text" name="applName" id="applName" class="AXInput W80"/>
						    			</th>

						    			<th style='width:10%;font-size: 13px;align:left;'>생년월일
										</th>
						    			<th style="width:20%;text-align:left;">
						    				<input type="text" name="applBirth" id="applBirth" class="AXInput W80"/>
						    			</th>

						    			<th style='width:15%;font-size: 13px;align:left;' colspan="2">고인과의 관계
						    			</th>
						    			<th style="text-align:left;">
						    				<input type="text" name="applRelation" id="applRelation" class="AXInput W80"/>
						    			</th>

						    			<tr>
						    			<th style='width:15%;font-size: 13px;align:left;'>주소
						    			</th>
						    			<th style="text-align:left;" colspan="6">
						    				<input style="width:85%" type="text" name="applAddr" id="applAddr" class="AXInput W80"/>
						    			</th>
						    		</tr>
						    		</tr>
								</table>
                                    	...
                                    	{label:"조회구분", labelWidth:"", type:"selectBox", width:"150", key:"searchKind", addClass:"", valueBoxStyle:"", value:"close", options:[],
	                                    	...
	                                    	AXBind: {
	                                            type: "select", config: {
	                                              ...
	                                              ajaxUrl: "/FUNE8100/search-kind-options",
	                                              ajaxPars: null,
	                                              setValue: "",
	                                              alwaysOnChange: true,
	                                              onChange: function() {
...
// 													_this.submit();
                ...
                grid: {
                        ...
                        target.setConfig({
                            ...
                            body : {//test
                                onclick: function(){
                                    ...
                                    var params = "CUSTOMER_NO=" + this.item.customerNo + "&applName=" + $("#applName").val() + "&applBirth=" + $("#applBirth").val() + "&applRelation=" + $("#applRelation").val() + "&applAddr=" + $("#applAddr").val() + "&printName=" + "${LOGIN_USER_NAME}";
                                    fnObj.report(params);
                                }
                            }
                            /* page: {
                    ...
                    setPage: function(pageNo, searchParams){
                        ...
                        var url = "/FUNE8100/dead";
                        if(searchKind == '1'){
                        	url = "/FUNE8010/assignedDead";
                        }
                ...
                report: function(params){
                	var path = "/reports/changwon/fune/FUNE8101";
                	var output = "pdf";
