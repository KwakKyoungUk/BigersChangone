                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	params.push("partName="+partName);
                   		console.log(params)
                		Common.report.go("/reports/changwon/fune/FUNE8141", "excel", params.join("&"));
                    });
                ...
                eventFunc: {
                	goPdf : function(){
                    	...
                    	params.push("partName="+partName);
                   		...
                   		console.log(params)
                   		Common.report.embedded("/reports/changwon/fune/FUNE8141", "pdf", params.join("&"), "if-pdf");
                	}
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
									{label:"발인일자", labelWidth:"", type:"inputText", width:"100", key:"from", addClass:"secondItem", valueBoxStyle:"", value:new Date().print(),
               							onChange: function(){}
               						},
									...
									{label:"파트", labelWidth:"", type:"selectBox", width:"100", key:"partCode", addClass:"", valueBoxStyle:"", value:"", options:[],
               							AXBind:{
               								type:"select", config:{
               									reserveKeys:{
               										options: "list",
