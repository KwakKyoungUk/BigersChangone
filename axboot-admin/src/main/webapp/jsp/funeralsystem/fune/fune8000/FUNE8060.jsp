            ...
            var fnObj = {
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                		...
                		if(fnObj.checked) {Common.report.embedded("/reports/changwon/fune/FUNE8061", "pdf", params.join("&"), "if-pdf");}
                    	else Common.report.embedded("/reports/changwon/fune/FUNE8061_1", "pdf", params.join("&"), "if-pdf");
                    });
                    ...
                    $("#ax-page-btn-excel").bind("click", function(){
                		...
                		if(fnObj.checked) {Common.report.go("/reports/changwon/fune/FUNE8061", "excel", params.join("&"));}
                    	else Common.report.go("/reports/changwon/fune/FUNE8061_1", "excel", params.join("&"));
