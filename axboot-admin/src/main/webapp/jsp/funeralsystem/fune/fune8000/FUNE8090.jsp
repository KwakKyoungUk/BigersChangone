                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	params.push("printName="+printName);
                   		console.log(params)
                		Common.report.go("/reports/changwon/fune/FUNE8091", "excel", params.join("&"));
                    });
                ...
                eventFunc: {
                	goPdf : function(){
                    	...
                    	params.push("printName="+printName);
                   		...
                   		console.log(params)
                   		Common.report.embedded("/reports/changwon/fune/FUNE8091", "pdf", params.join("&"), "if-pdf");
                	}
                },
                search: {
                    target: new AXSearch(),
