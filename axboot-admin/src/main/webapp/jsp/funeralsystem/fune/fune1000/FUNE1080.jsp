            ...
            var fnObj = {            	
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-excel").bind("click", function(){                		
                    	...
                    	from			= $("#"+fnObj.search.target.getItemId("balinDateFrom")).val().replace(/-/g, '')
                    	to				= $("#"+fnObj.search.target.getItemId("balinDateTo")).val().replace(/-/g, '')
                       	
                       	params.push("partCode="+partCode);
                       	params.push("FROM="+from);
                       	params.push("TO="+to);
                   		console.log(params)
                		Common.report.go("/reports/changwon/fune/FUNE1081", "excel", params.join("&"));
                    });
                ...
                eventFunc: {
                	goPdf : function(){
                    	...
                    	params.push("FROM="+from);
                   		...
                   		console.log(params)
                   		Common.report.embedded("/reports/changwon/fune/FUNE1081", "pdf", params.join("&"), "if-pdf");
                	}
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
									{label:"발인일자", labelWidth:"", type:"inputText", width:"70", key:"balinDateFrom", addClass:"", valueBoxStyle:"", value:new Date().print(),
               							onChange: function(){}
               						},
