		...
		<ax:row>
			<ax:col size="12">
				...
				<div class="ax-button-group">
					<div class="left">
						<h2>
							<i class="axi axi-list-alt"></i> ${PAGE_NAME}
						</h2>
					</div>
					<div class="right"></div>
            ...
            var fnObj = {
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                        Common.report.embedded("/reports/changwon/fune/FUNE1111", "pdf", fnObj.search.target.getParam(), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        Common.report.go("/reports/changwon/fune/FUNE1111", "excel", fnObj.search.target.getParam());
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
               						{label:"고인명/상제", labelWidth:"", type:"inputText", width:"90", key:"deadName", addClass:"secondItem", valueBoxStyle:"padding-left:0px;", value:"",
               									onChange:function(){
               									}
               						},
                                ]}
