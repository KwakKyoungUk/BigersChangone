...
//                     this.search.submit();
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                        Common.report.embedded("/reports/changwon/fune/FUNE1121", "pdf", fnObj.search.target.getParam(), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        Common.report.go("/reports/changwon/fune/FUNE1121", "excel", fnObj.search.target.getParam());
                    });
                },
                search: {
                    target: new AXSearch(),
