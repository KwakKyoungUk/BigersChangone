                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	...
                    	var codeName = null; 
                   		...
                   		codeName = $("#" + fnObj.search.target.getItemId("code") +" option:selected").text();
...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE1091", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	var codeName = null; 
                   		...
                   		params.push("code="+code);
                   		params.push("codeName="+codeName);
                        Common.report.go("/reports/changwon/fune/FUNE1091", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[						
                                	{label:"판매일자", labelWidth:"", type:"inputText", width:"70", key:"from", addClass:"", valueBoxStyle:"", value:new Date().print(),
       									onChange:function(){
            						...
            						{label:"결제구분", labelWidth:"100", type:"selectBox", width:"", key:"code", addClass:"", valueBoxStyle:"", value:"",
            							options:[
            								{optionValue:"", optionText:"전체"},
											{optionValue:"0", optionText:"현금"},
											{optionValue:"1", optionText:"카드"}
            							],
										AXBind: {
											type: "select",
											config: {
