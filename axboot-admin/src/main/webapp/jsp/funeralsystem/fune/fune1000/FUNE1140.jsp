                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	...
                    	var addrPart = null;
                    		...
                    		params.push("addrPart="+Common.search.getValue(fnObj.search.target, "addrPart"));
                    		params.push("printName="+'${LOGIN_USER_ID}');

//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE1141", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/fune/FUNE1141", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
               						...
               						{label:"자료구분", labelWidth:"", type:"selectBox", width:"150", key:"addrPart", addClass:"secondItem", valueBoxStyle:"", value:"",
               							options:[
											{optionValue:"", optionText:"전체"},
											{optionValue:"0", optionText:"수원"},
											{optionValue:"1", optionText:"화성"},
											{optionValue:"2", optionText:"용인"},
											{optionValue:"3", optionText:"경기도"},
											{optionValue:"4", optionText:"그외"},
               							],
	               						AXBind:{
	               							type:"select", config:{
