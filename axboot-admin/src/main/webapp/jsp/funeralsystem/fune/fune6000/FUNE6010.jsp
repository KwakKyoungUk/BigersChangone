...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE6011", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/fune/FUNE6011", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                            	{display:true, addClass:"", style:"", list:[
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"일별매출집계",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune6000/FUNE6020.jsp";
            					    		window.open(url, 'FUNE6020');
            							}
            						},
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"일일매출내역",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune6000/FUNE6030.jsp";
            					    		window.open(url, 'FUNE6030');
            							}
            						}
                            	]},
                                {display:true, addClass:"", style:"", list:[	
            						{label:"조회일자구분", labelWidth:"100", type:"selectBox", width:"", key:"DATE", addClass:"", valueBoxStyle:"", value:"", options:[],
										AXBind: {
            								type:"select", config:{
            									...
            									ajaxUrl:"/FUNE6010/basiccode",
            									ajaxPars:null,
            									setValue:"",
            									alwaysOnChange: false,
												onchange: function() {
													if(this.optionValue == 0)
														$("#"+fnObj.search.target.getItemId("FROM")).parent().siblings(".th").text("판매년월");
													else
														$("#"+fnObj.search.target.getItemId("FROM")).parent().siblings(".th").text("발인년월");
												}
											}
										}
            						},
                                	{label:"판매년월", labelWidth:"", type:"inputText", width:"90", key:"FROM", addClass:"", valueBoxStyle:"", value:new Date().print().substring(0,7),
       									onChange:function(){
