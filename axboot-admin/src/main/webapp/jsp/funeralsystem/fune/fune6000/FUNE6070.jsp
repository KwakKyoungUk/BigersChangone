                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	...
                    	to = Common.search.getValue(fnObj.search.target, "to");
                   		params.push("ST_DT="+from);
                   		params.push("ED_DT="+to);
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE6071", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	to = Common.search.getValue(fnObj.search.target, "to");
                   		params.push("ST_DT="+from);
                   		params.push("ED_DT="+to);
                        Common.report.go("/reports/changwon/fune/FUNE6071", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
                                	{label:"조회일자", labelWidth:"", type:"inputText", width:"70", key:"from", addClass:"", valueBoxStyle:"", value:new Date().print(),
       									onChange:function(){
