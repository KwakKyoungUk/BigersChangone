...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE2021", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	var code = null;
                   		...
                   		params.push("partName="+partName);
                   		params.push("code="+code);
                   		Common.report.go("/reports/changwon/fune/FUNE2021", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                ...
                                {display:true, addClass:"", style:"", list:[
            						...
            						{label:"파트", labelWidth:"100", type:"selectBox", width:"", key:"partCode", addClass:"", valueBoxStyle:"", value:"장례식장", options:[],
               							AXBind:{
            								type:"select", config:{
            									reserveKeys: {
                                                    options: "list",
