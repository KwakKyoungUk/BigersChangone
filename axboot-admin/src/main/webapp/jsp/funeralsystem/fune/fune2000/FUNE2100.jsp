            ...
            var fnObj = {            	
                ...
                bindEvent: function(){
                  ...
                  //검색부분 품목코드 , 품목명 엔터 조회
                    ...
                    $("#ax-page-btn-excel").bind("click", function(){                    	
                		...
                		Common.report.go("/reports/changwon/fune/FUNE2101", "excel", params.join("&"));
                    });
                ...
                eventFn: {
                	...
                	goPdf : function(){
                    	...
                    	TO			=  $("#TO").val();  
                   		...
                   		trace(code);
                   		Common.report.embedded("/reports/changwon/fune/FUNE2101", "pdf", params.join("&"), "if-pdf"); 
                ...
                gridItem: {
                    ...
                    setPage: function(searchParams){
                    	...
                    	app.ajax({
                            type: "GET",
                            url: "/FUNE2100/item?"+searchParams,
                            data: ""
                        },
                        function(res){
                        	if(res.error){
