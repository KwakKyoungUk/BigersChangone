        ...
        <script type="text/javascript">
            ...
            var fnObj = {
                CODES: {
                	...
                	, binsoType: Common.getCode("BINSO_TYPE")
                },
                pageStart: function(){
                	var params;
                	this.dateFormat();
                ...
                search: {
                    ...
                    bind: function(){
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                    	...
                                    	{label:"조회구분", labelWidth:"", type:"selectBox", width:"150", key:"searchKind", addClass:"", valueBoxStyle:"", value:"close", options:[],
	                                    	...
	                                    	AXBind: {
	                                            type: "select", config: {
	                                              ...
	                                              ajaxUrl: "/FUNE2050/search-kind-options",
	                                              ajaxPars: null,
	                                              setValue: "",
	                                              alwaysOnChange: true,
	                                              onChange: function() {
	                                            	  switch (this.value) {
														case '1':
															...
															$("#"+fnObj.search.target.getItemId("from")).prop("disabled", true);
															$("#"+fnObj.search.target.getItemId("to")).prop("disabled", true);
															break;
														case '2':
															$("#"+fnObj.search.target.getItemId("deadName")).prop("disabled", false);
															$("#"+fnObj.search.target.getItemId("from")).prop("disabled", false);
															$("#"+fnObj.search.target.getItemId("to")).prop("disabled", false);
															break;
	                            ...
	                            {display:true, addClass:"", style:"", list:[
									...
									{label:"발인일자", labelWidth:"", type:"inputText", width:"70", key:"from", addClass:"", valueBoxStyle:"", value:new Date().print(),
       									onChange:function(){
                        ...
                        setTimeout(function(){
                        	$("#"+fnObj.search.target.getItemId("from")).val("");
                        	$("#"+fnObj.search.target.getItemId("to")).val("");
                       		...
                       		$("#"+fnObj.search.target.getItemId("from")).bind("keyup", function(e){
                       			if($("#"+fnObj.search.target.getItemId("from")).val() == "" == "" && $("#"+fnObj.search.target.getItemId("to")).val() == ""){
                       				$("#"+fnObj.search.target.getItemId("deadName")).prop("disabled", false);
                       			}else{
                       				$("#"+fnObj.search.target.getItemId("deadName")).prop("disabled", true);
                       			}
                       		...
                       		$("#"+fnObj.search.target.getItemId("to")).bind("keyup", function(e){
                       			if($("#"+fnObj.search.target.getItemId("from")).val() == "" == "" && $("#"+fnObj.search.target.getItemId("to")).val() == ""){
                           			$("#"+fnObj.search.target.getItemId("deadName")).prop("disabled", false);
                       			}else{
                       				$("#"+fnObj.search.target.getItemId("deadName")).prop("disabled", true);
                ...
                grid: {
                    ...
                    bind: function(){
                        ...
                        target.setConfig({
                            ...
                            colGroup : [
                                ...
                                {key:"deadAge", label:"나이", width:"80"},
                                {key:"binsoType", label:"빈소종류", width:"80", align:"center", formatter: function(){
                                	return Common.grid.codeFormatter("binsoType", this.value);
                                }},
                                {key:"binsoName", label:"빈소", width:"80", align:"center"}
                            ],
                            body : {//test
                                onclick: function(){
                                    ...
                                    info = "| 고인정보 | "+ this.item.customerNo + " | " + this.item.deadName + " | " + this.item.binsoName + " | " + this.item.balinDate;
                                    $("#deadInfo").html(info);
                    ...
                    setPage: function(pageNo, searchParams){
                        ...
                        var url = "/FUNE2050/dead";
                        if(searchKind == '1'){
                        	url = "/FUNE2050/assignedDead";
                        }
                        ...
                        app.ajax({
                        	...
                        	$("#partCode").bindSelect({
                                ...
                                , onChange: function(){
                                    ...
                                    var params = fnObj.grid.params+"&partCode="+partCode.optionValue+"&partName="+partCode.optionText;
                                    fnObj.report(params);
                                }
                            	, setValue: partCode
                            });
                ...
                report: function(params){
                	var path = "/reports/changwon/fune/FUNE2051";
                	var output = "pdf";
