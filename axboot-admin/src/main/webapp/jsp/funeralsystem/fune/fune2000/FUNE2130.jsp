                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                    	...
                    	var codeName2 = null;
                   		...
                   		code3 = Common.search.getValue(fnObj.search.target, "code3");
                   		codeName = $("#" + fnObj.search.target.getItemId("code2") +" option:selected").text();
                   		codeName2 = $("#" + fnObj.search.target.getItemId("code3") +" option:selected").text();
                   		...
                   		params.push("code3="+code3);
                   		params.push("codeName="+codeName);
                   		params.push("codeName2="+codeName2);
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE2131", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/fune/FUNE2131", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
            						{label:"조회일자구분", labelWidth:"100", type:"selectBox", width:"70", key:"code", addClass:"", valueBoxStyle:"", value:"", options:[],
               							AXBind:{
            								type:"select", config:{
            									reserveKeys: {
                                                    options: "list",
                                	...
                                	{label:"정산일자", labelWidth:"", type:"inputText", width:"90", key:"from", addClass:"", valueBoxStyle:"", value:new Date().print(),
               							onChange: function(){}
               						},
                                	...
                                	{display:true, addClass:"", style:"", list:[
                						{label:"매출구분", labelWidth:"100", type:"selectBox", width:"70", key:"code2", addClass:"", valueBoxStyle:"", value:"", options:[],
                   							AXBind:{
                								type:"select", config:{
                									reserveKeys: {
                                                        options: "list",
                						...
                						{label:"정산구분", labelWidth:"100", type:"selectBox", width:"76", key:"code3", addClass:"", valueBoxStyle:"", value:"", options:[],
                   							AXBind:{
                								type:"select", config:{
                									reserveKeys: {
                                                        options: "list",
