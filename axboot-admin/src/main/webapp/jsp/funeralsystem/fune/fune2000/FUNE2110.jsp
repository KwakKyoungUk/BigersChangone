...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE2111", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/fune/FUNE2111", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                            	{display:true, addClass:"", style:"", list:[
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"일별정산집계",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune2000/FUNE2120.jsp";
            					    		window.open(url, 'FUNE2120');
            							}
            						},
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"일일정산내역",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune2000/FUNE2130.jsp";
            					    		window.open(url, 'FUNE2130');
            							}
            						}
                            	]},
                                {display:true, addClass:"", style:"", list:[						
            						{label:"조회일자구분", labelWidth:"100", type:"selectBox", width:"108", key:"code", addClass:"", valueBoxStyle:"", value:"", 
            							options:[
                                	...
                                	{label:"정산년월", labelWidth:"", type:"inputText", width:"70", key:"from", addClass:"", valueBoxStyle:"", value:new Date().print().substring(0,7),
               							onChange: function(){}
               						},
                                	...
                                	{display:true, addClass:"", style:"", list:[
                						{label:"매출구분", labelWidth:"100", type:"selectBox", width:"108", key:"code2", addClass:"", valueBoxStyle:"", value:"", options:[],
                   							AXBind:{
                								type:"select", config:{
                									reserveKeys: {
                                                        options: "list",
                						...
                						{label:"파트", labelWidth:"100", type:"selectBox", width:"", key:"partCode", addClass:"hidden", valueBoxStyle:"", value:"", options:[],
                   							AXBind:{
                								type:"select", config:{
                									reserveKeys: {
                                                        options: "list",
