...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE2091", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/fune/FUNE2091", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                            	{display:true, addClass:"", style:"", list:[
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"품목매출내역",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune2000/FUNE2100.jsp";
            					    		window.open(url, 'FUNE2100');
            							}
            						}
                            	]},
                                {display:true, addClass:"", style:"", list:[
                                ...
                                {display:true, addClass:"", style:"", list:[
            								...
            								type:"select", config:{
            									...
            									onChange:function(){
            										$("#"+fnObj.search.target.getItemId("groupCode")).bindSelect({
                    									...
                    									ajaxUrl:"/FUNE2090/itemgroup",
                    									ajaxPars:"partCode="+this.value,
                    									setValue:"",
                                                        isspace: true, isspaceTitle: "전체",
                    									onChange:function(){
                    										//toast.push(Object.toJSON(this));
            						...
            						{label:"품목분류", labelWidth:"100", type:"selectBox", width:"", key:"groupCode", addClass:"", valueBoxStyle:"", value:"", options:[],
               							AXBind:{
            								type:"select", config:{
            									reserveKeys: {
                                                    options: "list",
