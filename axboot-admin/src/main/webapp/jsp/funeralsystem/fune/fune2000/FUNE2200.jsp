...
//                     this.search.submit();
                ...
                bindEvent: function(){
                    ...
                    $("#ax-page-btn-search").bind("click", function(){
                        ...
                        Common.report.embedded("/reports/changwon/fune/FUNE2201", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/fune/FUNE2201", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                                {display:true, addClass:"", style:"", list:[
               						{label:"년도", labelWidth:"", type:"inputText", width:"50", key:"from", addClass:"secondItem", valueBoxStyle:"", value:new Date().print("yyyy"),
               							
               						AXBind:{
           								type:"date", config:{
           									align:"right", valign:"top", startTargetID:"from", selectType:"y",
           									onChange:function(){
           										//fnObj.grid.setPage();
           									}
           								}
