...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE2011", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                    	...
                    	var code = null;
                   		...
                   		params.push("partName="+partName);
                   		params.push("code="+code);
                        Common.report.go("/reports/changwon/fune/FUNE2011", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                            ...
                            rows:[
                            	{display:true, addClass:"", style:"", list:[
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"일별매출집계",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune2000/FUNE2020.jsp";
            					    		window.open(url, 'FUNE2021');
            							}
            						},
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"일일매출내역",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune2000/FUNE2030.jsp";
            					    		window.open(url, 'FUNE2031');
            							}
            						}
                            	]},
                                {display:true, addClass:"", style:"", list:[
            						{label:"조회일자구분", labelWidth:"100", type:"selectBox", width:"", key:"code", addClass:"", valueBoxStyle:"", value:"close",
										options:[
											{optionValue:"0", optionText:"판매년월"},
                                	...
                                	{label:"일자", labelWidth:"", type:"inputText", width:"70", key:"from", addClass:"", valueBoxStyle:"", value:new Date().print().substring(0,7),
       									onChange:function(){
                    ...
                    submit: function(){
                    	//return fnObj.search.bind.datename;
//                     	var params = [];
//                     	var from = null;
//                     	var to = null;
