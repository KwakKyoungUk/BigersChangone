                	...
                	<ax:custom customid="tr">
                      	...
                      	<ax:custom customid="td">
                      		<table cellpadding="0" cellspacing="0" class="AXGridTable" style="height: 45px;">												    
						    	<tbody>
						    		<tr>
						    			<th style='width:10%;font-size: 14px;'>조회일자
										</th>
						    			...
						    			<th style='width:15%;font-size: 14px;'>조회적용일자구분
										</th>
            ...
            var fnObj = {            	
                  ...
                  //검색부분 품목코드 , 품목명 엔터 조회
                    ...
                    $("#ax-page-btn-excel").bind("click", function(){                    	
                    	...
                    	TO			=  $("#TO").val();     
                       	...
                       	DATE		= $("#code").val() == 00 ? 0:1;
                       	name		= $("#code" + " option:selected").text()+"일자";
                		...
                		Common.report.go("/reports/changwon/fune/FUNE3111", "excel", params.join("&"));
                    });
                ...
                eventFn: {
                	...
                	goPdf : function(){
                    	...
                    	TO			=  $("#TO").val();     
                   		...
                   		trace(params);
                   		Common.report.embedded("/reports/changwon/fune/FUNE3111", "pdf", params.join("&"), "if-pdf"); 
                ...
                gridItem: {
                    ...
                    setPage: function(searchParams){
                    	...
                    	app.ajax({
                            type: "GET",
                            url: "/FUNE3110/item?"+searchParams,
                            data: ""
                        },
                        function(res){
                        	if(res.error){
