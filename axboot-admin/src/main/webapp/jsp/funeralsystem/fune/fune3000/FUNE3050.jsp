...
//                     this.search.submit();
                ...
                extendObject: function(){
                	...
                	Date.prototype.getBeforeSeven = function() {
...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE3051", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/fune/FUNE3051", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                            	{display:true, addClass:"", style:"", list:[
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"거래처매입내역",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune3000/FUNE3060.jsp";
            					    		window.open(url, 'FUNE3060');
            							}
            						}
                            	]},
                                {display:true, addClass:"", style:"", list:[						
                                	{label:"매입년월", labelWidth:"", type:"inputText", width:"90", key:"from", addClass:"", valueBoxStyle:"", value:new Date().getBeforeSeven(),
