...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE3031", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/fune/FUNE3031", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                            ...
                            rows:[
                            	{display:true, addClass:"", style:"", list:[
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"일일매입내역",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune2000/FUNE3030.jsp";
            					    		window.open(url, 'FUNE3041');
            							}
            						}
                            	]},
                                {display:true, addClass:"", style:"", list:[
                                	{label:"매입년월", labelWidth:"", type:"inputText", width:"90", key:"from", addClass:"", valueBoxStyle:"", value:new Date().print(),
               							AXBind:{
               								type:"Date", config:{
                            	...
                            	{display:true, addClass:"", style:"", list:[
            						...
            						{label:"매입거래처", labelWidth:"100", type:"inputText", width:"", key:"", addClass:"", valueBoxStyle:"", value:".", options:[],
               							AXBind:{
