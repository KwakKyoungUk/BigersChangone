...
//                         Common.report.open("/reports/stat/${PAGE_ID}", "pdf", params.join("&"));
                        Common.report.embedded("/reports/changwon/fune/FUNE3021", "pdf", params.join("&"), "if-pdf");
                    });
                    $("#ax-page-btn-excel").bind("click", function(){
                        ...
                        Common.report.go("/reports/changwon/fune/FUNE3021", "excel", params.join("&"));
                    });
                },
                search: {
                    target: new AXSearch(),
                        ...
                        this.target.setConfig({
                            ...
                            rows:[
                            	{display:true, addClass:"", style:"", list:[
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"일별매입집계",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune3000/FUNE3030.jsp";
            					    		window.open(url, 'FUNE3031');
            							}
            						},
            						{label:"", labelWidth:"", type:"button", width:"100", key:"button", addClass:"", valueBoxStyle:"", value:"일일매입내역",
            							onclick: function(){
            				    			var url = "/jsp/funeralsystem/fune/fune3000/FUNE3040.jsp";
            					    		window.open(url, 'FUNE3041');
            							}
            						}
                            	]},
                                {display:true, addClass:"", style:"", list:[
                                	{label:"매입년월", labelWidth:"", type:"inputText", width:"90", key:"from", addClass:"", valueBoxStyle:"", value:new Date().print().substring(0,7),
       									onChange:function(){
