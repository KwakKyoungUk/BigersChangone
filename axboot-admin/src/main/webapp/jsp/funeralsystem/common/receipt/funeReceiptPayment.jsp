...
<div class="section">
	<table>
		...
		<tr><td>
			<table>
				<tr>
					<td>발인일자 : ${yyyyMMddHHmm.format(funeral.balinDate) }
					</td>
				</tr>
			</table>
		</td></tr>
		...
		<tr><td>
			<table>
				<tr>
					...
					<td align="right">${df.format(payment.noTaxAmt) } 원
					</td>
				</tr>
				<tr>
					<td>과세금액
					</td>
					<td align="right">${df.format(payment.netAmt) } 원
					</td>
				</tr>
				<tr>
					<td>부 가 세
					</td>
					<td align="right">${df.format(payment.vatAmt) } 원
					</td>
				</tr>
			</table>
		</td></tr>
		...
		<tr><td>
			<table>
				...
				<tr>
					...
					<td align="right">${yyyyMMddHHmm.format(funeral.regtime) }
					</td>
				</tr>
				<tr>
					<td>고인명
