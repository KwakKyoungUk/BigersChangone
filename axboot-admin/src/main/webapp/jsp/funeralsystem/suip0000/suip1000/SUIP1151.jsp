...
//검색조건:
 ...
 // ----- 숫자에 3 자리 마다 컴마 찍기 종료  --- //
	...
	//업무ID: 진해 화장장,봉안당 수입일보 : 0000000xd
	String seconddata  = "";
	String frmID = "0000000xd";
...
<input name="frmName" type="hidden"  value="장사통합@MS마산봉안당운영일지">
<input name="frmId" type="hidden"    value="0000000xd">
    ...
    <ax:div name="scripts">
         ...
         */
        	function goList(){
        		...
        		mainform.action			= "/SUIP1151/appMngLay?actionTp=appMngDataSrchList";
            ...
            */
        	...
        	function goMssqlInsert(){
        		...
        		*/
        		...
        		mainform.target			= "_self";
        		mainform.method			= "post";
        		mainform.action			= "/SUIP1151/appMngLay?actionTp=appMngDataSrchInsert_one";
