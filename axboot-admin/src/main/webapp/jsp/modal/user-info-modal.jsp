<%@ page import="com.axisj.axboot.core.domain.user.User" %>
...
<%
	...
	User user = CommonUtils.getCurrentLoginUser();
	
	pageContext.setAttribute("cd", user.getUserCd());
				...
				<ax:form name="table-form" id="table-form" method="post">
					<ax:fields>
						<ax:field label="아이디" width="220px">
							<input type="text" name="userCd" id="userCd" maxlength="15" title="이름"
								   class="av-required AXInput W120" value="${cd}" readonly="readonly"/>
						</ax:field>
					</ax:fields>
					<ax:fields>
