...
<ax:layout name="base.jsp">
    <ax:set name="title" value="${pageName}" />
    <ax:set name="page_desc" value="${pageRemark}" />
    <ax:div name="contents">
        <ax:row>
            <ax:col size="12">
                <ax:custom customid="page-button" pageId="${pageId}" searchAuth="${searchAuth}" saveAuth="${saveAuth}" excelAuth="${excelAuth}" function1Auth="${function1Auth}" function2Auth="${function2Auth}" function3Auth="${function3Auth}" function4Auth="${function4Auth}" function5Auth="${function5Auth}">
                ...
                <div class="ax-button-group">
                    <div class="left">
                        <h2><i class="axi axi-storage"></i> 정보리스트</h2>
                    </div>
                    <div class="right">
