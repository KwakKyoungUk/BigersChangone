    ...
    <ax:row>
      <ax:col size="12" wrap="true">
        ...
        <ax:form id="form-notice" name="form-notice" method="get">
          ...
          <ax:fields>
            <ax:field label="업체코드" width="300px">
              <select class="AXSelect" id="compCd" name="compCd" style="width:120px;"></select>
              <span class="hint">미선택 시 전체공지</span>
            </ax:field>
          </ax:fields>
          <ax:fields>
          ...
          <ax:fields>
            <ax:field label="내용" style="width:100%">
                <textarea name="content" id="content" class="AXTextarea" style="box-shadow:inset 0px 0px 3px #ccc;width:100%;height:385px;ime-mode:active;box-sizing: border-box;" title="내용"></textarea>
            </ax:field>
          </ax:fields>
          <ax:fields>
      ...
      var fnObj = {
        ...
        dataForm: {
          ...
          bind: function(){
            ...
            /*
            $("#insDt").bindDate(
                    {align:"left", valign:"bottom", separator:"-", defaultSelectType:"d", onchange:function(){}
                    });
            $("#insDt").val(app.dateObj.nowDate());
            */

            $("#endDt").bindTwinDate({align:"right", valign:"bottom", separator:"-", startTargetID:"stDt", selectType:"d", onChange:function(){}});

            $("#popupYn").bind("change", function(){
              if (this.value=="Y"){
                //$("#stDt").attr("readonly", false);
            ...
            if (document["form-notice"].id.value!=""){
              app.ajax({
                ...
                else
                {
                  ...
                  //console.log(res);
                  //$("#compCd").bindSelectSetValue(res.compCd);
