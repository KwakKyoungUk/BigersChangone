	        ...
	        grid: {
	            ...
	            bind: function(){
	                this.target.setConfig({
	                    ...
	                    */
	                    colGroup : [
                            {key:"compCd", label:"업체코드", width:"80", align:"center"},
                            {key:"compNm", label:"업체", width:"120", align:"center", formatter:function(){
                                return (this.value) ? this.value : "전체";
                            }},
	                        {key:"title", label:"제목", width:"*", align:"left"},
	                        {key:"insDate", label:"등록일", width:"80", align:"center", formatter:function(){
                                if (this.value!=""){
