    ...
    <ax:row>
      <ax:col size="12" wrap="true">
        ...
        <ax:form id="form-notice" name="form-notice" method="post">
          ...
          <ax:fields>
            <ax:field label="업체코드" width="150px">
              <label id="compCd"></label>
            </ax:field>
            <ax:field label="업체명" width="150px">
              <label id="compNm"></label>
            </ax:field>
          </ax:fields>
          <ax:fields>
      ...
      var fnObj = {
        ...
        dataBind: function(){
          app.ajax({
            ...
            {
              $("#insDate").html(res.insDate.date().print());
              $("#compCd").html(res.compCd);
              $("#compNm").html(res.compNm);
