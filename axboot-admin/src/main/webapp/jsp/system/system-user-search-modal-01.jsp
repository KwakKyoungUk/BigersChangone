                            ...
                            */
							...
							rows:[
								{display:true, addClass:"", style:"", list:[
									{label:"업체", labelWidth:"60", type:"selectBox", width:"", key:"compCd", addClass:"", valueBoxStyle:"", value:"",
										options:[],
										AXBind:{
											type:"select", config:{
												reserveKeys: {
												...
												method:"GET", ajaxUrl: "/api/v1/companies/authorized", ajaxPars: "menuType=SYSTEM&pageNumber=0&pageSize=50",
												isspace: false, isspaceTitle: "",
												setValue:"",
												alwaysOnChange: true,
												onchange:function(){
													//console.log(this);
													fnObj.search.compCd = this.value;
													fnObj.search.compNm = this.text;
